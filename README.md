<h2 align="center">Find Devices On Network</h2>
<p align="center">
...
### Haga una bifurcación de el [proyecto ](https://github.com/compose-projects-android/FindDevicesOnNetwork) a su repositorio privado
...
```
git clone https://github.com/compose-projects-android/FindDevicesOnNetwork.git
```
...
```
git remote add upstream https://github.com/compose-projects-android/FindDevicesOnNetwork
```
